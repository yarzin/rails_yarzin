...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { account_id: @friendship.account_id, create: @friendship.create, destroy: @friendship.destroy, friend_id: @friendship.friend_id }
    end
  ...
  test "should update friendship" do
    patch :update, id: @friendship, friendship: { account_id: @friendship.account_id, create: @friendship.create, destroy: @friendship.destroy, friend_id: @friendship.friend_id }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
